...
const testPrivateKey: string = process.env.TEST_PRIVATE_KEY || "fbdcaf506fad1a1ce1eb24481a3925f75df8b2d7c2d44842d9c4782a20b07e8b";
const alchemyKey: string = process.env.ALCHEMY_KEY || "qQg5dG4h-LO3xb2VuVru1qJL56O-wrY3";
